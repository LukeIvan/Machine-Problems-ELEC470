...
all: $(PTHREAD_BIN) $(SEQUENTIAL_BIN) $(OPENMP_BIN) $(MATRIX_SEQ_BIN) $(MATRIX_OMP_BIN) $(MATRIX_EPC_BIN)
...
clean:
	rm -f $(PTHREAD_BIN) $(SEQUENTIAL_BIN) $(OPENMP_BIN) $(MATRIX_SEQ_BIN) $(MATRIX_OMP_BIN) $(MATRIX_EPC_BIN)
